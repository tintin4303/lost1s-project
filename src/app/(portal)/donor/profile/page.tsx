        ...
        <div className="min-h-screen bg-amber-50">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-3xl mx-auto space-y-8">
                    ...
                    {/* Role Management - Switch to Adopter */}
                    ...
                    <Dialog
                        ...
                        title="Enable Adopter Features?"
                        description="This will give you access to the Adopter Portal where you can browse pets and schedule meetings. You will keep your Donor access."
                    >
                        <DialogFooter>
                            <Button variant="ghost" onClick={() => setShowAdopterModal(false)}>
                                Cancel
                            </Button>
                            <Button
                                className="bg-green-600 hover:bg-green-700 text-white"
                                onClick={async () => {
                                    try {
                                        const res = await fetch('/api/user/me', {
                                            ...
                                            body: JSON.stringify({ role: 'ADOPTER' })
                                        });
                                        if (res.ok) {
